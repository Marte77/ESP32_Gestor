...
# android_zigbee_kotlin folder
- Kotlin Android app that connects directly to Zigbee2MQTT via MQTT
- lists devices from `zigbee2mqtt/bridge/devices` and renders controls for writable exposes
